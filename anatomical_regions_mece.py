...
# base_directory = Path("/Users/mimi/MaxPlanck/mapzebrain/server/media/NewRegions/Test_PYImageJ")
...
def start_MECEing_kunst_regions():
    ...
    os.makedirs(images_sequences_dir, exist_ok=True)
    ...
    os.makedirs(mece_sequences_dir, exist_ok=True)
    ...
    os.makedirs(coronal_regions_dir, exist_ok=True)
    ...
    os.makedirs(sagittal_regions_dir, exist_ok=True)
